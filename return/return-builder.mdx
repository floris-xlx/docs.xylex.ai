Here’s the complete documentation page for the `Return` utility function, expanded to include an explanation of the code:

---

### `Return` Utility Function Documentation
